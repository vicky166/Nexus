...
export default function Navbar() {
  return (
    <header className="sticky top-0 w-full z-50">
      ...
      <div className="flex h-20 w-full items-center px-6 bg-green-900 text-white shadow-lg">
        <Sheet>
        ...
        <NavigationMenu className="hidden lg:flex">
          <NavigationMenuList className="gap-0.5">
            <NavigationMenuLink asChild>
              <Link
                href="#"
                className="group inline-flex h-10 items-center justify-center rounded-md px-3 text-sm font-medium hover:bg-white/5"
              >
                Aesthetic Clinic
              </Link>
            </NavigationMenuLink>
        ...
        <div className="ml-auto flex items-center gap-3">
          <button className="text-white p-2 rounded-md hover:bg-white/5">
            <Search className="h-5 w-5" />
          </button>

          <Button className="bg-[#E5D5CA] text-[#2F5649] hover:bg-[#E5D5CA]/90 h-10 px-5 text-sm font-medium">
            Book Now
          </Button>
