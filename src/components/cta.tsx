const CTA = () => {
    return (
      <div className="bg-[#F2FDF6] min-h-screen flex flex-col justify-center items-center text-center px-8 py-16">
        <div className="max-w-6xl w-full bg-[#F2FDF6] p-12 rounded-lg  flex flex-col items-center">
          ...
          <div className="bg-green-100 p-10 mt-6 rounded-lg shadow-md w-full max-w-4xl">
          ...
          <a
            href="#"
            className="mt-8 inline-block bg-green-600 text-white px-12 py-5 rounded-full font-semibold text-2xl hover:bg-green-700 transition shadow-lg"
          >
