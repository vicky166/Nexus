      ...
      <div className="container mx-auto grid lg:grid-cols-2 gap-12 px-6 md:px-12 lg:px-24 py-12 items-center">
        <div className="space-y-6">
          ...
          <p className="text-lg text-gray-700 max-w-xl">
            Discover professional skincare solutions with cutting-edge laser technology. 
            Say goodbye to fine lines, wrinkles, and skin imperfections for a flawless glow.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <Button 
              className="flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white rounded-full px-8 py-3 text-lg font-semibold shadow-lg transition-all hover:scale-105"
            >
